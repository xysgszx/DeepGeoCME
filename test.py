...
"""Run the fusion model on the test events and plot the prediction results."""
...
# ----------------------------------------------------------------------------- figure
def plot_results(cm: dict, out: Path):
    """2x2 confusion matrix with rows = true class (N, Y), columns =
...
def main(argv=None):
    ...
    ap.add_argument("--out", default=str(HERE / "confusion_matrix.png"))
